...
guide. The unlisted, 1,535-event record follows the work from assignment review
...
hardening. It is a credential-scrubbed export of the authentic sessions and
complements the sanitized [build log](BUILD_LOG.md).
